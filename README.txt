...
P.S. Для студентов ИТМО следующих поколений
Если берешь лабу себе, имей в виду: данная реализация не дает выигрыша по сжатию в сравнении с двухпроходным Хаффманом, поэтому за нее дадут только 10 баллов. Я получила 20, т.к. еще 10 были бонусом за рассказ об алгоритме на семинаре.
